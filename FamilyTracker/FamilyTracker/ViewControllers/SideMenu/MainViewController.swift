...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Side Menu
        self.sideMenuViewController = UIStoryboard.dashboardSharedInstance.instantiateViewController(withIdentifier: "SideMenuID") as? SideMenuViewController
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "DashboardViewController")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    ...
    func showViewController<T: UIViewController>(viewController: T.Type, storyboardId: String) -> () {
        ...
        let vc = UIStoryboard.dashboardSharedInstance.instantiateViewController(withIdentifier: storyboardId)
        vc.view.tag = 99
